...
int main(int argc, char **argv)
{
  ...
  12:	83 ec 04             	sub    $0x4,%esp
    ...
    if (fork() == 0)
  15:	e8 91 02 00 00       	call   2ab <fork>
  1a:	85 c0                	test   %eax,%eax
  1c:	75 16                	jne    34 <main+0x34>
        printf(1, "child process\n");
  1e:	52                   	push   %edx
  1f:	52                   	push   %edx
  20:	68 78 07 00 00       	push   $0x778
  25:	6a 01                	push   $0x1
  ...
  2f:	e8 7f 02 00 00       	call   2b3 <exit>
        wait();
  34:	e8 82 02 00 00       	call   2bb <wait>
        printf(1, "parent process\n");
  39:	50                   	push   %eax
  3a:	50                   	push   %eax
  3b:	68 87 07 00 00       	push   $0x787
  40:	6a 01                	push   $0x1
  42:	e8 c9 03 00 00       	call   410 <printf>
  47:	83 c4 10             	add    $0x10,%esp
  4a:	eb e3                	jmp    2f <main+0x2f>
  4c:	66 90                	xchg   %ax,%ax
  4e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 594:	eb 1a                	jmp    5b0 <printf+0x1a0>
          s = "(null)";
 596:	bb 97 07 00 00       	mov    $0x797,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e5:	a1 48 0a 00 00       	mov    0xa48,%eax
{
...
malloc(uint nbytes)
{
 ...
 67d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 680:	8b 3d 48 0a 00 00    	mov    0xa48,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
